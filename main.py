...
if __name__ == '__main__':
    ...
    parser.add_argument('--engine', type=str, default='sougou')  # 所采用的搜索引擎 可选项 google，baidu，sougou
    ...
    parser.add_argument('--save_path', type=str, default='./download/蜡笔小新')  # 保存路径
    ...
    parser.add_argument('--min_count', type=int, default=20)  # 当下载图片数量大于该数值时，程序停止 # 若为0则无限下载
