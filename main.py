...
if __name__ == '__main__':
    ...
    parser.add_argument('--query', type=str, default='关键字')  # 搜索关键词 建议google引擎使用英文进行搜索
    ...
    parser.add_argument('--save_path', type=str, default='./download/关键字')  # 保存路径
    ...
    parser.add_argument('--min_count', type=int, default=150)  # 当下载图片数量大于该数值时，程序停止 # 若为0则无限下载
